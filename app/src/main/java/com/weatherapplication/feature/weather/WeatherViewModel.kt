...
class WeatherViewModel @Inject constructor(private val weatherRepository: WeatherRepositoryInterface) :
    ...
    private val _weather: MutableLiveData<com.learnig.android.mydata.data.remoteapi.State<WeatherModelLocal>> = MutableLiveData()
    val weather: MutableLiveData<com.learnig.android.mydata.data.remoteapi.State<WeatherModelLocal>>
        get() = _weather
